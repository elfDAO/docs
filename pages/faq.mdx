...
Crowdfund websites take fees off every single donation transaction. We want every dollar of donations to go towards purchasing gifts for kids. Our overhead costs to deploy the smart contracts and transfer the ETH to USD will be significantly less than the amount a crowdfund site would take. In addition, DAO governance mechanisms allow the donator community as a whole to decide where funds raised are going.
