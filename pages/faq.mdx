...
Crowdfund websites take fees off every single donation transaction. We don't want that. Instead, we thought it would be more worth to have every dollar of donations in tact for purchasing gifts. Our overhead costs to deploy the smart contracts and transfer the ETH to USD will be significantly less than the amount a crowdfund site would take.
