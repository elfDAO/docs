...
### Connect Wallet
Go to the [elfDAO Juicebox project page](https://juicebox.money/#/p/elfdao) and connect your wallet by selecting the **“Connect Wallet”** button on the top right.

<Callout>If you created a Coinbase Wallet or Metamask account, select your repsective wallet and a pop up will appear. You may be asked to enter your password to your account. Once you click "connect”, your wallet will be connected to Juicebox.</Callout>
...
#### 1. Connnect Wallet
Go to the [elfdao website](https://elfdao.com/) and connect your wallet by selecting the “Connect Wallet” button on the home page. A dialog box should appear and you will be able to select what type of wallet to connect. Upon clicking on your respective wallet, you should be prompted to connect your wallet.
...
<Callout>As a reminder, you can mint an Elf NFT at any time if you donate 0.1 ETH or more on Juicebox. You can mint a Reindeer NFT if you are one of the first 970 people to donate 0.5 ETH or more on Juicebox.</Callout>
